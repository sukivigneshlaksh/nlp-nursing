...
Uses Vertex AI with structured output via responseSchema.
"""
                    ...
                    "properties": {
                        ...
                        "fields": {
                            ...
                            "items": {
                                ...
                                "required": ["field_name", "label", "field_type", "value"]
                            }
                        }
                    },
...
def fill_form_structure(structure_json: dict, transcript: str) -> dict:
    ...
    # Use the same schema as the input structure
    filled_schema = {
        "type": "object",
        "properties": {
            "form_name": {"type": "string"},
