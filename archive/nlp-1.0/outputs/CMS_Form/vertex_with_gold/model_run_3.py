...
class PapForm(BaseModel):
    ...
    symptoms_improvement: Optional[bool] = Field(None, description="Did the report period show improvement in symptoms of obstructive sleep apnea with the use of PAP?")
    ...
    equipment_description: Optional[str] = Field(None, description="Narrative description of equipment, accessories, and options ordered")
